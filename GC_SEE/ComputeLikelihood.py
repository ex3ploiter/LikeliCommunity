...
class LikelihoodComputer(nn.Module):
    def __init__(self, dataset, config):
        ...
        self.hidden_dim = 64  # Adjust as needed
        self.dataset=dataset
        
        # Create models
        
        self.hidden_model, self.mean_model, self.std_model =get_VGAE_hidden_models(dataset,hidden_dim)
    ...
    def train_epoch(self, data):
        ...
        adj_output, mu, logvar = self.model(data.cpu())

        loss = self.loss_function(adj_output, mu, logvar, adj)
